<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:62:"E:\devspace\shouquan/application/admin\view\product\index.html";i:1519270078;s:60:"E:\devspace\shouquan/application/admin\view\public\base.html";i:1519889335;s:62:"E:\devspace\shouquan/application/admin\view\public\header.html";i:1519268025;s:62:"E:\devspace\shouquan/application/admin\view\public\footer.html";i:1518438136;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="row">
    <div class=" col-lg-12 col-sm-12">
        ...
        <div class="pull-right"  style="margin-top: 20px;">
            ...
            <a class="btn btn-primary openwin" href="<?php echo url('admin/product/add'); ?>"  >新增产品</a>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="#" class="editable editable-click" data-id="<?php echo $item['id']; ?>"
                               data-name="title" data-type="text" data-pk="<?php echo $item['id']; ?>" data-url="<?php echo url('editable'); ?>"><?php echo $item['title']; ?></a>
                         </td>
                        <td>
                            <a href="#" class="editable editable-click" data-id="<?php echo $item['id']; ?>"
                               data-name="description" data-type="textarea" data-pk="<?php echo $item['id']; ?>" data-url="<?php echo url('editable'); ?>"><?php echo $item['description']; ?></a>
                        </td>
                        <td>
                            <a title="编辑" href="<?php echo url('/admin/product/add?id='.$item['id']); ?>" class="openwin">编辑</a>

                            <a class="confirm ajax-get" title="删除" href="<?php echo url('/admin/product/delete',array('id'=>$item['id'])); ?>">删除</a>
                        </td>
                    </tr>
