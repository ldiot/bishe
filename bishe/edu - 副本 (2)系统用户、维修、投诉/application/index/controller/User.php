...
//        return '11111'.$result;
    ...
    public function adminEdit(Request $request){
        ...
        $this->view->assign('desc','PHP中文网ThinkPHP5开发实践课程');
...
//        return $request->param('status');
        ...
        $result=UserModel::update($data,$condition)?true:false;
...
//        UserModel::update(['delete_time'=>NULL],['is_delete'=>1]);//无用
        //tp5恢复软删除目前已知的只有一种方法，写原生sql语句。
        $sql = ' update user set delete_time = NULL where is_delete=1' ;//delete_time是数据库中自定义的删除标识字段。
        Db::execute($sql);
    }
